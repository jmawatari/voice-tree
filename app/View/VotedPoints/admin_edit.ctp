...
<?php echo $this->Form->create('VotedPoint'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Voted Point'); ?></legend>
	<?php
		echo $this->Form->input('voted_point_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VotedPoint.voted_point_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VotedPoint.voted_point_id'))); ?></li>
