<div class="clients index">
	...
	<tr>
		...
		<td><?php echo h($client['Client']['client_type']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['website_name']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['website_url']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['subdomain']); ?>&nbsp;</td>
